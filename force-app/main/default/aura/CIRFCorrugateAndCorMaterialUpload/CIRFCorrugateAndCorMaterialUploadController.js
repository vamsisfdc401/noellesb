({
    ...
    downloadTemplate : function(component,event,helper){
        helper.callServer(component,"c.getCIRFCorrugateTemplate",function(response){
            var hiddenElement = document.createElement('a');
            hiddenElement.href = 'data:text/csv;charset=utf-8,' + encodeURI(response);
            hiddenElement.target = '_self'; // 
            hiddenElement.download = 'CIRF Corrugate Upload Template.csv';  // CSV file Name* you can change it.[only name not .csv] 
